...
public partial class user_payment_success : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            //marrja e te dhenave te klientit dhe ruajtja ne tabelen Order_Details
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                cmd1.CommandText = "insert into Orders values('"+dr["firstname"].ToString()+ "','" + dr["lastname"].ToString() + "','" + dr["email"].ToString() + "','" + dr["address"].ToString() + "','" + dr["country"].ToString() + "','" + dr["city"].ToString() + "','" + dr["postal_code"].ToString() + "','" + dr["mobile"].ToString() + "')";
                cmd1.ExecuteNonQuery();
            }
            //perfundimi i shtimit te te dhenave

            //marrja e id nga tabela Orders
            ...
            //perfundimi i marrjes se id se order-it

            //marrja e produkteve te porositura nga cookies
            if (Request.Cookies["cookie1"] != null)
            {
                ...
                //mbyllja e marrjes se te dhenave
            }
            else
            {
