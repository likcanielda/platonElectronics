...
<asp:Content ID="Content1" ContentPlaceHolderID="contentPlaceHolder1" Runat="Server">
    <asp:Repeater ID="repeater1" runat="server">
       <HeaderTemplate>
        ...
        <ItemTemplate>
          <li class="product"> <a href="product_description.aspx?id=<%#Eval("id")%>"><img src="../<%# Eval("product_images")%>"" alt="" /></a>
            <div class="product-info">
              <h3><%# Eval("product_name")%></h3>
              <div class="product-desc">
                <h4>Quantity available:<%# Eval("product_qty")%></h4>
                <p><%# Eval("product_desc")%></p><br />
